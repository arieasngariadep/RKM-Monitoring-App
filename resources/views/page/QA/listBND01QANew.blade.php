...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">List BND01QA New</li>
</ol>
@endsection('breadcrumbs')

@section('titleTab', 'QA BND01 | List Data BND01QA New')
@section('title', 'List Data BND01QA New')
...
<div class="row">
    <div class="col-lg-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <p class="text-muted mb-3">List Data BND01QA New</p> 
                <form action="<?= route('getListBND01QANew') ?>" method="GET">
            ...
            <div class="row mb-4">
                <div class="col-md-4 text-right">
                    <a type="button" class="btn btn-success btn-square btn-outline-dashed waves-effect waves-light" href="../Excel/format_searchbulk_BND01QA_New.xlsx"><i class="dripicons-cloud-download mr-2"></i>&nbsp;Download Format</a>
                </div>
                <div class="col-md-2 text-center">
                    <button class="btn btn-dark" style="width: 200px; height: 38px;" href="#" data-toggle="modal" data-animation="bounce" data-target=".search-bulk-qa-new"><i class="dripicons-search"></i>&nbsp;&nbsp;Search Bulk</button>
                </div>
                <?php if($txn_dte != NULL || $report_dte != NULL || $merch_id != NULL || $card_nbr != NULL || $rrn != NULL || $description != NULL) : ?>
                <div class="col-md-2 text-left">
                    <form class="form-inline" action="<?= route('prosesExportReportSearchBND01QANew') ?>" method="POST">
                        @csrf
                ...
                <div class="col-md-4 text-left">
                    <form action="{{ route('prosesDeleteBnd01QANew') }}" method="POST">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
                        <input type="text" class="form-controle" name="txn_dte" value="<?= $txn_dte ?>" hidden />
                        <input type="text" class="form-controle" name="report_dte" value="<?= $report_dte ?>" hidden />
