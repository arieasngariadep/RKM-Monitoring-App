...
class ReportSearchQAExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithCustomValueBinder, WithColumnFormatting
{
    ...
    */
    ...
    {
        $this->data = ReportModel::getDataReportSearchExportBND01QA($this->txn_dte, $this->report_dte, $this->merch_id, $this->card_nbr, $this->rrn, $this->description);
