...
class ReportSearchBulkQANewExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithCustomValueBinder, WithColumnFormatting
{
    ...
    */
    ...
    {
        $this->data = ReportModel::getDataReportSearchBulkExportBND01QANew($this->userId);
