...
class ReportSearchTCExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithCustomValueBinder, WithColumnFormatting
{
    ...
    */
    ...
    {
        $data = TapCashModel::getReportSearchTC($this->txn_date, $this->start_proc_date, $this->end_proc_date, $this->mid, $this->cardnum, $this->auth, $this->amount, $this->report_name);
