...
class BND01QAModel extends Model
{
    protected $table = 'bnd01qa';
    protected $guarded = [];
    public $timestamps = true;
    protected $fillable = ['id', 'report_dte', 'merch_id', 'card_nbr', 'amount', 'txn_dte' , 'rrn', 'description', 'created_at', 'updated_at'];

    public function getListBND01QA($txn_dte, $report_dte, $merch_id, $card_nbr, $rrn, $description)
    {
    ...
    public function deleteListBND01QA($txn_dte, $report_dte, $merch_id, $card_nbr, $rrn, $description)
    {
        $bnd = new BND01QAModel;
        if(isset($txn_dte) || isset($report_dte) || isset($merch_id) || isset($card_nbr) || isset($rrn) || isset($description))
        {
    ...
    public function countItemByDateQA($reportDate){
