	...
	with open(namafile, "r") as f:
		...
		for i, line in enumerate(f):
			...
			if i>newIndex+9 and "." in line[80:81]:
				...
				array = [oo_batch, txn_date, auth, cardnum, amount, rate, disc_amount,net_amount, noMerchant,bankName, namaMerchant, noRek,namaRek, procDate,reportName]
				datatable.append(array)
		return pd.DataFrame(datatable)

if __name__ == '__main__':
	df = openflat("D:/xampp/htdocs/rkm/public/Import/TapCash/folder_" + sys.argv[1] + "/" + sys.argv[2])
	df.columns = ["OO BATCH","TXN-DATE","AUTH","CARD NUMBER","AMOUNT","RATE","DISC.AMT","NET_AMOUNT","NO.MERCHANT","BANK NAME","MERCHANT NAME","NO.REK","REK NAME","PROC DATE","REPORT NAME"]

	df.to_excel("D:/xampp/htdocs/rkm/public/Import/TapCash/hasil_tapCash_" + sys.argv[1] + ".xlsx", index=False)